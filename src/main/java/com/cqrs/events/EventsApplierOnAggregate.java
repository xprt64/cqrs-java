...
public class EventsApplierOnAggregate {
    ...
    public void applyEvent(Aggregate aggregate, EventWithMetaData eventWithMetaData) throws AggregateExecutionException {
        try {
            Method method = aggregate.getClass().getMethod(
                Aggregate.METHOD_NAME, eventWithMetaData.event.getClass(), eventWithMetaData.metadata.getClass()
            );
